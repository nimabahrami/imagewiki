...
titles_wrap= textwrap.wrap(titles, width=25)

font=ImageFont.truetype(font='georgia.ttf',size=22)
font_title=ImageFont.truetype(font='georgiab.ttf',size=26)
font_credit=ImageFont.truetype(font='georgia.ttf',size=14)
